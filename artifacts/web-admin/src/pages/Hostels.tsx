          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {hostelStaff.length === 0 ? (
                <p className="text-sm text-slate-600 italic">No staff assigned to this hostel</p>
              ) : (
            ...
            <div>
              ...
              {hostelStudents.length === 0 ? (
                <p className="text-sm text-slate-600 italic">No students assigned to this hostel</p>
              ) : (
                <div className="max-h-72 overflow-y-auto space-y-1.5 pr-1">
                  {hostelStudents.map((s: any) => {
                    const inv = inventoryMap[s.id];
                    const messCard = inv?.messCard;
                    const status = s.attendanceStatus;
                    return (
                      <div key={s.id} className="flex items-center gap-3 bg-white/3 border border-white/5 rounded-xl px-3 py-2.5">
